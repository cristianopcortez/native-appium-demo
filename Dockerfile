...
# Plugin 8.2.2 (used by the Espresso driver's on-device test APK build)
...
# The Appium Espresso driver uses Android Gradle Plugin 8.2.2, which requires
# compileSdk 34 (platforms;android-34) and build-tools;34.0.0 to rebuild the
# test server APK. The base image only ships android-28 + build-tools 36, so
